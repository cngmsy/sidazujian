...
import static com.example.lenovo.android_a12.TagAliasOperatorHelper.ACTION_ADD;
import static com.example.lenovo.android_a12.TagAliasOperatorHelper.ACTION_CHECK;
import static com.example.lenovo.android_a12.TagAliasOperatorHelper.ACTION_CLEAN;
import static com.example.lenovo.android_a12.TagAliasOperatorHelper.ACTION_DELETE;
import static com.example.lenovo.android_a12.TagAliasOperatorHelper.ACTION_GET;
import static com.example.lenovo.android_a12.TagAliasOperatorHelper.ACTION_SET;
import static com.example.lenovo.android_a12.TagAliasOperatorHelper.TagAliasBean;
import static com.example.lenovo.android_a12.TagAliasOperatorHelper.sequence;
...
public class PushSetActivity extends InstrumentedActivity implements OnClickListener {
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            startActivity(new Intent(PushSetActivity.this,Main2Activity.class));
            finish();
        }
